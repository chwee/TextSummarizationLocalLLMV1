...
system_prompt = st.text_area(
    label="System Prompt",
    value="you are a expert LLM summarizer. Provide a concise summary from user input text. Ensure the summary is content accurate information from the given text",
    key="system_prompt")
